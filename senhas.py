...
def get_password(service):
    ...
    if cursor.rowcount == 0: #Faz uma varredura pra ver se tem algum serviço cadastrado
...
while True:
    menu()
    op = input("O que deseja fazer?").lower()
    ...
    if op == 'r':
        service = input('Qual serviço você deseja ver as senhas? ')
